...
public class Server {
    // Set port number
    private static int portNumber = 1077;
    private static String ip = "127.0.0.1";
    // Set binding name for student administration
    private String bindingName = "AuthenticationManager";

    // References to registry and student administration
    private Registry registry = null;
    private AuthenticationManagerInterface serverManager = null;
    ...
    public Server() throws SQLException, IOException, ClassNotFoundException {
        ...
        serverManager = new AuthenticationManagerServer();
